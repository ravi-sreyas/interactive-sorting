function startMergeSort() {
    ...
    ai = 0;
    mergeSort(elementsToBeSorted, 0, elementsToBeSorted.length);
    updateHTMLElementsWithArray(arrayOfArrays, 0, arrayOfArrays.length-1);
}

function mergeSort (unsortedArray, leftI, rightI) {
    ...
    return merge(
      mergeSort(left, leftI, leftI+middle), mergeSort(right, leftI+middle, rightI), leftI, leftI+middle, leftI+middle, rightI
    );
  }
